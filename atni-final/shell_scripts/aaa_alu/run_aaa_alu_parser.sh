...
cd $ATNI_REPO/common
sudo -u gtt python check_duplicate_file.py aaa_alu

cd $ATNI_REPO/aaa_alu

spark-submit --master yarn \
--py-files $ATNI_REPO/bin/aaa_alu.zip, $ATNI_REPO/bin/common.zip \
./aaa_alu_main.py $IN_PATH
